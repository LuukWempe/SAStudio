...
import com.stedin.HighVoltage.model.users.*;
...
public class AppUserService implements UserDetailsService {
	...
	public void registerUser(
		...
		if (user == null){
			switch (role) {
				case "SAENGINEER":
					AppUser newUser = new SAEngineer(username, firstName, lastName, email, password, role, enabled, activated);
	...
	public void registerUser(
		...
		if (user == null){
			switch (role) {
				case "TRAINEE":
					AppUser newUser = new SAEngineer(username, firstName, lastName, email, password, role, enabled, activated, dateofbirth, zipcode, street, streetNr, city, country, telephonenumber);
					appUserRepository.save (newUser);
					break;
				case "ADMIN":
